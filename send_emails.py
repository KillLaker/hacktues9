...
def send_emails():
    ...
    number_of_old_messages = len(mail_ids)
    ...
    print(f"old: {number_of_old_messages}, new: {len(mail_ids)}")

    if(len(mail_ids) == number_of_old_messages + 1):
